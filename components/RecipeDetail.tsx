...
import { askChefAboutRecipe } from '../services/geminiService';
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-orange-50 p-4 rounded-xl">
            <p className="text-xs text-orange-500 font-semibold mb-1">FLAVOR</p>
            <p className="font-medium text-gray-800">{recipe.基本信息.味型}</p>
          </div>
          <div className="bg-blue-50 p-4 rounded-xl">
            <p className="text-xs text-blue-500 font-semibold mb-1">BEST BY</p>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-5 rounded-2xl border border-indigo-100">
                ...
                {!aiResponse && (
                    <p className="text-xs text-indigo-400">
                        Tap "Get Pro Tip" to ask Gemini 2.5 Flash for cooking secrets.
                    </p>
                )}
            </div>
        </div>
